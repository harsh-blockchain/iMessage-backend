  ...
  */
  ...
  export type MessageGetPayload<S extends boolean | null | undefined | MessageArgs> =
    ...
    [P in TruthyKeys<S['include']>]:
        ...
        P extends 'isLatestIn' ? ConversationGetPayload<S['include'][P]> | null :
    ...
    [P in TruthyKeys<S['select']>]:
        ...
        P extends 'isLatestIn' ? ConversationGetPayload<S['select'][P]> | null :
        P extends 'sender' ? UserGetPayload<S['select'][P]> :  P extends keyof Message ? Message[P] : never
  } 
      : Message
